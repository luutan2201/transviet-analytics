...
// LinkedIn has no weekly granularity — only month/quarter/year report types.
...
export function LinkedInReportContent() {
  const { data: dashboard, isError, refetch } = useLinkedInDashboard();
  ...
  return (
    <div className="flex flex-col gap-8">
      <PageHeader
        title="LinkedIn AI Report"
        subtitle="Tạo báo cáo điều hành tự động từ dữ liệu LinkedIn hiện tại"
      />
